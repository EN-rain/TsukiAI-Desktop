...
- Deployed service source: Git commit `3e09304` (OpenVoice source files deployed from that commit); the VM is configured with `OPENVOICE_SPEED_EN=1.0`, `OPENVOICE_SPEED_JA=1.0`, and `OPENVOICE_OUTPUT_SAMPLE_RATE=24000`.
