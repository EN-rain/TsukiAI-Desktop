...
- Deployed service source: Git commit `c9cadbc` (OpenVoice `EN_NEWEST` base selection and Discord voice-message mastering); the VM is configured with `OPENVOICE_BASE_SPEAKER_EN=EN-NEWEST`, `OPENVOICE_SPEED_EN=1.0`, `OPENVOICE_SPEED_JA=1.0`, and `OPENVOICE_OUTPUT_SAMPLE_RATE=24000`.
