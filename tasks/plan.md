...
- Deployed service source: pending this verified Free.ai-match update; the VM will use `OPENVOICE_BASE_SPEAKER_EN=EN-US`, `OPENVOICE_SPEED_EN=0.8`, `OPENVOICE_SPEED_JA=1.0`, and `OPENVOICE_OUTPUT_SAMPLE_RATE=24000`, with API-side denoise/loudness mastering.
