...
- Matching calibration: the active target was calibrated from the user-provided Free.ai OpenVoice render (`https://api.free.ai/static/outputs/7b9bd60e-aa2b-4634-9473-ce8aabda71b4.wav`, SHA-256 `29d6f5f7411a60cd8a19c54097fccb9535bc185f3f9a5477d34f0d3d3b968d8e`); the original-reference embedding remains on the VM as `tsuki_se.pth.reference-vad`.
...
- Deployed service source: Git commit `41023bc` (OpenVoice source files deployed from that commit); the VM is configured with `OPENVOICE_SPEED_EN=0.9` and `OPENVOICE_SPEED_JA=1.0`.
...
- Fresh live validation: the calibrated English render was 12.643265 seconds at 22.05 kHz versus the Free.ai WAV at 13.680000 seconds and 24 kHz; direct converter embedding cosine between the active target and the fresh render was 0.86404032.
